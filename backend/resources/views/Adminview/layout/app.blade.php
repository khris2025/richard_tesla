         ...
         <div data-simplebar class="h-100">
            ...
            <div id="sidebar-menu">
               ...
               <ul class="metismenu list-unstyled" id="side-menu">
                  ...
                  <li>
                     <a href="{{ route('pending_tesla_purchase') }}">
                     <i data-feather="shopping-cart"></i>
                     <span data-key="t-dashboard">Pending Tesla purchase</span>
                     </a>
                  </li>
                  <li>
                  ...
                  <li>
                     <a href="{{ route('add_tesla') }}">
                     <i data-feather="shopping-cart"></i>
                     <span data-key="t-dashboard">Add Tesla</span>
                     </a>
                  </li>
                  <li>
